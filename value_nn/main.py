...
new_data = vi.get_dataset(params, 1000, n_model, init_price, mean, init_dist=True)
...
for _ in range(50):
    ...
    pred.next_gm_train(train_ds.data, dist_new, n_model, params, n_model.optimizer_next_gm, 1000, 10, 50)
