...
class KTParam():
    def __init__(self):
        ...
        self.eta = 3.6142
        self.B = 0.002
        self.ashock = np.array([0.9328, 0.9658, 1.0000, 1.0354, 1.0720])
        self.nz = 5
        self.pi_a = Pi = np.array([[0.8537, 0.1377, 0.0083, 0.0002, 0.0000],
        ...
        self.ishock = np.array([0.9328, 0.9658, 1.0000, 1.0354, 1.0720])
        self.pi_i = np.array([[0.8537, 0.1377, 0.0083, 0.0002, 0.0000],
                                [0.0344, 0.8579, 0.1035, 0.0042, 0.0001],
                                [0.0014, 0.0690, 0.8593, 0.0690, 0.0014],
                                [0.0001, 0.0042, 0.1035, 0.8579, 0.0344],
                                [0.0000, 0.0002, 0.0083, 0.1377, 0.8537]])
